...
namespace curvature
{
    ...
    class CurvatureCalculator {
         ...
         */
        void computePrincipalDirections(size_t v_index, btm::btm_vector<VertexCurvature<T>>& curvatures)    // input vertex for which to compute principal directions
        {
            ...
            btm_vector<std::uint32_t>& nbrs = va.neighbor_vertices;
    ...
    public:
        ...
        void compute_vertex_curvatures() {
            btm::btm_vector<VertexCurvature<T>>& curvatures = mesh.vertex_curvatures;
            curvatures.clear();
