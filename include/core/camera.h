/// \file gl_camera.h
/// \brief Declares the `btm_framework::gl_camera` class, a simple OpenGL camera wrapper.
...
namespace btm_framework {
    ...
    class gl_camera {
        ...
        btm_framework::fvec3 location;

        /// \brief Point in world space the camera is looking at.
        btm_framework::fvec3 target;

        /// \brief Up direction of the camera in world space.
        btm_framework::fvec3 up = btm_framework::fvec3(0, 1, 0);
    ...
    public:
        ...
        gl_camera(const btm_framework::fvec3& _location,
                  const btm_framework::fvec3& _target,
                  const btm_framework::fvec3& _up = btm_framework::fvec3(0, 1, 0)) :
        ...
        /// \param _target   Look-at target point in world space.
        /// \param _up       Up direction vector (defaults to +Y).
        void setup(const btm_framework::fvec3& _location,
                   const btm_framework::fvec3& _target,
                   const btm_framework::fvec3& _up = btm_framework::fvec3(0, 1, 0))
        {
            location = _location;
        ...
        btm_framework::fmat4 view_perspective() {
        ...
        btm_framework::fmat4 camera_perspective() {
        ...
        btm_framework::fmat4 perspective() {
        ...
        void zoom(float delta) {
            ...
            btm_framework::fvec3 delta_vec = forward() * delta * s;
            location += delta_vec;
        }

        /// \brief Returns the current camera position in world space.
        const btm_framework::fvec3& get_location() const { return location; }

        /// \brief Returns the current look-at target in world space.
        const btm_framework::fvec3& get_target() const { return target; }
    };
}
