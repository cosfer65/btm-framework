...
namespace btm_framework {
    ...
    struct curvatureData {
        ...
        curvatureData() : k_1(0), k_2(0), meanCurvature(0), gaussCurvature(0), abs_k_1(0), abs_k_2(0),
            absMeanCurvature(0), absGaussCurvature(0), signGauss(0), signMean(0) {}
        void reset() {
            k_1 = 0; k_2 = 0; meanCurvature = 0; gaussCurvature = 0;
            abs_k_1 = 0; abs_k_2 = 0; absMeanCurvature = 0; absGaussCurvature = 0;
    ...
    struct meshVertex {
        ...
        int curvature_map_value; // this can be used to store a single scalar curvature classification value for visualization
